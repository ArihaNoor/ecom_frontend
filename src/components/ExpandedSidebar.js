...
const ExpandedSidebar = ({ onClose }) => {
  ...
  return (
    <div className="h-screen bg-white text-gray-900 w-[15%] flex flex-col py-6 shadow-lg">
      <div className="w-full flex justify-end p-4">
        <button onClick={onClose} className="focus:outline-none">
          <i className="fa-solid fa-times text-lg bg-gray-100 px-3 py-1 rounded-lg hover:bg-gray-200"></i>
        </button>
      </div>
